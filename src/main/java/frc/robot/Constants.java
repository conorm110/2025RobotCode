...
public class Constants {
    ...
    public static final class Elevator {
        ...
        public static final double inchesMultiplier = 1.079913607; // multiply by input inches to get actual inches that should be sent to motor -- TODO: account for this in the inchesPerRot variable above
